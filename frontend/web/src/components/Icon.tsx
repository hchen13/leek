// Inline SVG icons. Stroke-based, monoline. Ported from prototype/leek-icons.jsx.

import type { JSX } from "solid-js";

type IconName =
  | "chat" | "canvas" | "brain" | "book" | "grid" | "settings"
  | "plus" | "search" | "send" | "paperclip" | "sparkles" | "mic"
  | "play" | "pause" | "expand" | "close" | "chevronR" | "chevronD"
  | "bolt" | "layer" | "pin" | "eye" | "branch";
...
export function Icon(props: { name: IconName; class?: string }) {
  return (
    <svg class={props.class ?? "ic"} viewBox="0 0 24 24">
      {PATHS[props.name]}
    </svg>
  );
}
